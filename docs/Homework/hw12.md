...
!!! question "Step 1: Create a new Volume"
    Unity's volume system is the main way to control the visual settings per camera in HDRP. Multiple volumes may share the same profile. We are able to adjust the size of the volume, contrast, saturation, and much more. When the camera enters the volume, the settings then are applied to the frame. 
...
!!! question "Step 2: Create a new Profile"
    Then, create a new profile

    ![Image title](../Homework/hw13/MLProject.png)

!!! question "Step 3: Add Override"
    Then, `Add Override` and `Color Adjustments`

    ![Image title](../Homework/hw13/MLProject.png)

!!! question "Step 4: Experiment!"
...
!!! question "Step 5: Disable the Fog"
...
!!! question "Step 6: Visual Environment"
...
!!! question "Step 7: Sky Exposure Values"
...
!!! question "Step 6: Baked Lightmaps"
    For the objects to participate in the Global Illumination (GI) computation, we will need to check the Contribute GI in our meshes. Make sure they all receive lighting from our lightmaps. 
...
!!! question "Step 8: Rendering Debugger"
...
!!! question "Step 9: Reflection Probes"
    ...
    Lets start with adding a **reflection probe** in front of the camera. By default, it is a baked reflection probe and looks like a black sphere. Once baked, it has successfully captured the surrounding environment.
...
!!! question "Step 2: Add an APV to the Scene"
...
!!! question "Step 3: Light and Mesh Renderer Settings"
...
!!! question "Step 4: Bake your Lighting"
    ...
    * Select the `Adaptive Probe Volumes` panel if needed. 
    * Set `Baking Mode` to `Scene`.
    ![Image title](../Homework/hw13/MLProject.png)
...
!!! question "Step 6: Probe Placement with APV"
