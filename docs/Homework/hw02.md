...
Before we get can get started with the homework problems, please **fork** the following repository [`https://github.com/debbieyuen/ctin583-hw02.git`](https://github.com/debbieyuen/ctin583-hw02.git).
